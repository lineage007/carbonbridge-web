      ...
      <div>
        ...
        <div style={{ background: 'linear-gradient(175deg, #0C1C14, #1B3A2D 60%, #0C1C14)', padding: '80px 0 72px' }}>
          <div className="max-w-[800px] mx-auto px-4 lg:px-8 text-center">
            ...
            <p style={{ fontFamily: bg, fontSize: '16px', color: '#8AAA92', lineHeight: 1.7, maxWidth: '600px', margin: '0 auto' }}>
              CarbonBridge exists because carbon markets shouldn&apos;t require a degree in environmental science to navigate. We connect buyers who need verified credits with the developers who produce them, and we are building institutional-grade data, settlement and insurance into each step.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div>
              ...
              <div style={{ fontFamily: bg, fontSize: '14px', color: '#3D3830', lineHeight: 1.8 }}>
                ...
                <p>This fragmentation is a large part of why carbon markets have not scaled to match the urgency of the climate crisis.</p>
              </div>
            </div>
            <div>
              ...
              <div style={{ fontFamily: bg, fontSize: '14px', color: '#3D3830', lineHeight: 1.8 }}>
                ...
                <p style={{ marginBottom: '14px' }}>CarbonBridge is neither an exchange nor a registry. It is the workflow layer that makes carbon markets accessible to organisations with a compliance obligation or a voluntary commitment.</p>
          ...
          <div style={{ background: 'linear-gradient(135deg, #0C1C14, #1B3A2D)', borderRadius: '20px', padding: 'clamp(32px, 5vw, 48px)', marginBottom: '48px' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { stat: 'COP28', label: 'hosted in the UAE, a catalyst for regional commitment', detail: 'UAE Net Zero 2050 strategy + Article 6.4 mechanism launched' },
          ...
          <div style={{ marginBottom: '48px' }}>
            ...
            <h2 style={{ fontFamily: fr, fontSize: '28px', fontWeight: 600, color: '#1A1714', marginTop: '8px', marginBottom: '20px' }}>The team</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: 'Integrity over volume', text: 'We would rather facilitate 10,000 high-quality tonnes than 1 million questionable ones. Our quality ratings exist because carbon credits are not all equal, and treating them as equal damages the whole market.' },
                ...
                { title: 'Insurance is not optional', text: 'We are building credit insurance into checkout because buyers should not need to be carbon market experts to protect their purchase. Cover will be optional for the buyer, and offering it is a requirement we set for ourselves.' },
                { title: 'The compliance wave is an opportunity', text: 'NRCC, CORSIA, CBAM and VCMI create real demand for high-quality credits. CarbonBridge is built to serve the organisations that have to meet them.' },
              ].map(v => (
          ...
          <div className="text-center" style={{ marginTop: '64px', padding: '48px', background: 'linear-gradient(135deg, #0C1C14, #1B3A2D)', borderRadius: '20px' }}>
            ...
            <p style={{ fontFamily: bg, fontSize: '14px', color: '#8AAA92', marginBottom: '24px' }}>Buying for compliance or listing credits for sale, you can start with a free account.</p>
