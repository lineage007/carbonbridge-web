...
export default function Page() {
  return (
    <div>
      <h1 style={{ fontFamily: fr, fontSize: "26px", color: "#F2ECE0", marginBottom: "8px" }}>Financials</h1>
      <p style={{ fontFamily: bg, fontSize: "14px", color: "#6B8A74" }}>Admin financials management</p>
